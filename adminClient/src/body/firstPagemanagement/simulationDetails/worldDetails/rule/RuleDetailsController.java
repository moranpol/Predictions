package body.firstPagemanagement.simulationDetails.worldDetails.rule;

import body.firstPagemanagement.simulationDetails.worldDetails.rule.actions.calculation.CalculationController;
import body.firstPagemanagement.simulationDetails.worldDetails.rule.actions.decrease.DecreaseController;
import body.firstPagemanagement.simulationDetails.worldDetails.rule.actions.increase.IncreaseController;
import body.firstPagemanagement.simulationDetails.worldDetails.rule.actions.kill.KillController;
import body.firstPagemanagement.simulationDetails.worldDetails.rule.actions.multipleCondition.MultipleConditionController;
import body.firstPagemanagement.simulationDetails.worldDetails.rule.actions.proximity.ProximityController;
import body.firstPagemanagement.simulationDetails.worldDetails.rule.actions.replace.ReplaceController;
import body.firstPagemanagement.simulationDetails.worldDetails.rule.actions.set.SetController;
import body.firstPagemanagement.simulationDetails.worldDetails.rule.actions.singleCondition.SingleConditionController;
...
public class RuleDetailsController {
    ...
    private void createSingleConditionActionToShow(DtoAction dtoAction) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/body/firstPagemanagement/simulationDetails/worldDetails/rule/actions/singleCondition/SingleCondition.fxml"));
    ...
    private void createSetActionToShow(DtoAction dtoAction) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/body/firstPagemanagement/simulationDetails/worldDetails/rule/actions/set/Set.fxml"));
    ...
    private void createReplaceActionToShow(DtoAction dtoAction) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/body/firstPagemanagement/simulationDetails/worldDetails/rule/actions/replace/Replace.fxml"));
    ...
    private void createProximityActionToShow(DtoAction dtoAction) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/body/firstPagemanagement/simulationDetails/worldDetails/rule/actions/proximity/Proximity.fxml"));
    ...
    private void createMultipleConditionActionToShow(DtoAction dtoAction) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/body/firstPagemanagement/simulationDetails/worldDetails/rule/actions/multipleCondition/MultipleCondition.fxml"));
    ...
    private void createKillActionToShow(DtoAction dtoAction) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/body/firstPagemanagement/simulationDetails/worldDetails/rule/actions/kill/Kill.fxml"));
    ...
    private void createIncreaseActionToShow(DtoAction dtoAction) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/body/firstPagemanagement/simulationDetails/worldDetails/rule/actions/increase/Increase.fxml"));
    ...
    private void createDecreaseActionToShow(DtoAction dtoAction) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/body/firstPagemanagement/simulationDetails/worldDetails/rule/actions/decrease/Decrease.fxml"));
    ...
    private void createCalculationActionToShow(DtoAction dtoAction) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/body/firstPagemanagement/simulationDetails/worldDetails/rule/actions/calculation/Calculation.fxml"));
