package simulationDetails.worldDetails;
...
import simulationDetails.worldDetails.entity.EntityDetailsController;
import simulationDetails.worldDetails.environment.EnvironmentDetailsController;
import simulationDetails.worldDetails.grid.GridDetailsController;
import simulationDetails.worldDetails.rule.RuleDetailsController;
...
public class WorldDetailsController {
    ...
    public void showEntity(String entityName){
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/simulationDetails/worldDetails/entity/EntityDetails.fxml"));
    ...
    public void showEnvironment(){
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/simulationDetails/worldDetails/environment/EnvironmentDetails.fxml"));
    ...
    public void showGrid() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/simulationDetails/worldDetails/grid/GridDetails.fxml"));
    ...
    public void showRule(String ruleName){
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/simulationDetails/worldDetails/rule/RuleDetails.fxml"));
