package body.firstPagemanagement.simulationDetails;

import body.firstPagemanagement.simulationDetails.worldDetails.WorldDetailsController;
...
public class DetailsController implements Closeable {
    ...
    private void loadWorldDetailsController(DtoWorldInfo dtoWorldInfo){
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/body/firstPagemanagement/simulationDetails/worldDetails/WorldDetails.fxml"));
