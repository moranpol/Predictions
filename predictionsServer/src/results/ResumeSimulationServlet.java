...
@WebServlet(name = "resume simulation servlet", urlPatterns = "/resumeSimulation")
@MultipartConfig
public class ResumeSimulationServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        try {
            ...
            manager.resumeSimulation(Integer.parseInt(request.getParameter("request id")), Integer.parseInt(request.getParameter("simulation id")));
        } catch (Exception e){
